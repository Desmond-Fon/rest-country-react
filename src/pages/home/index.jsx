...
const Home = ({name, setName, region, setRegion, showCountry, countries, showName, showRegion, changeRegion, searchCountry}) => {
    ...
    return ( <main className="px-5 bg-veryLightGrayLM text-veryDarkBlueLM pt-7 dark:bg-veryDarkBlueDM dark:text-whiteLMDM w-full">
        ...
        {showCountry ? <DisplayCountry countries = {countries} showName = {showName}/> : showRegion ?
         <DisplayRegions changeRegion = {changeRegion} showName = {showName}/> : <DisplaySearch searchCountry = {searchCountry} showName = {showName}/>}
